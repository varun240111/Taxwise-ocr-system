...
const sections = [
  {
    ...
    items: [
      ...
      { label: "Tax analytics", icon: BarChart3, page: "analytics" },
    ],
  },
  {
    title: "Documents",
    ...
    <>
      ...
      <aside
        className={`
          ...
          border-r border-[#1e2c27] bg-[#07100d]
      ...
      >
        <button
          type="button"
          onClick={() => setSidebarOpen(false)}
          className="absolute right-4 top-4 z-50 flex h-8 w-8 items-center justify-center rounded-full border border-[#27332f] bg-[#111917] text-[#e8f0ec] lg:hidden"
        >
          ✕
        </button>
            ...
            <div className="flex h-[70px] items-center gap-3 border-b border-[#1e2c27] px-[18px]">
              ...
              {!collapsed && (
                <div className="min-w-0 flex-1">
                  <h1 className="truncate text-[16px] font-extrabold tracking-[-0.3px] text-[#e8f0ec]">
              ...
              <button
                ...
                className="hidden h-[26px] w-[26px] shrink-0 cursor-pointer items-center justify-center rounded-full border border-[#27332f] bg-[#111917] text-[#c9933a] transition hover:bg-[#17211e] lg:flex"
              >
                <ChevronLeft
                  size={14}
                  strokeWidth={2.5}
            ...
            {!collapsed && (
              <div className="mx-[14px] mt-3 rounded-xl border border-[#27332f] bg-[#111917] px-[14px] py-3">
                ...
                <p className="mb-2 text-[12.5px] font-bold text-[#e8f0ec]">
                  {profileCompleted ? "Completed" : "Not completed"}
                </p>

                <div className="h-[3px] overflow-hidden rounded-full bg-[#27332f]">

                <div
                  className={`h-full rounded-full bg-gradient-to-r from-[#19b985] to-[#c9933a] ${
                    profileCompleted ? "w-full" : "w-0"
                  }`}
                />
                </div>
                ...
                <div className="mt-2 flex items-start gap-1.5 text-[10.5px] leading-4 text-[#7f8b85]">
                  ...
                  />
                  <span>{profileCompleted
                            ? "Profile completed. Tax insights unlocked"
                            : "Complete profile to unlock tax insights"}
                  </span>
                </div>
              </div>
            )}
